...
def main():
    ...
    #version 2, according to instruction the UNIQUE is define by First+LastName. ID seems not to be UNIQUE, diffrent ID
    # can have diffrent usernames. But test case fails, So I try to use ID to label each user for uniqueness.
...
class Testing(unittest.TestCase):
    ...
    def test_mysplit_2(self):
        ...
        expected = ['1992728315', 'ZARUBINSKY', 'aaaaa', '"PANCRELIPASE 5,000"', '1227.63']
        actual = mysplit(line,{'1992728315':('ZARUBINSKY','aaaaa')})
        self.assertEqual(expected, actual)
